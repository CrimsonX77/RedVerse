...
Date: January 9, 2026
"""
ARGS="python3 consciousness_server.py --soul Sable_Cathedral_v5_3.yaml --port 7777"
import argparse
import socket
import threading
import asyncio
...
def main():
    ...
    parser.add_argument('--soul', type=str, required=True,
                        help='Soul YAML filename (e.g., Sable_Cathedral_v5_3.yaml)')
    parser.add_argument('--port', type=int, default=7777,
                        help='Port to listen on (default: 7777)')
    parser.add_argument('--host', type=str, default='localhost',
                        help='Host to bind to (default: localhost)')
    parser.add_argument('--souls-dir', type=Path, default=Path.home() / "Desktop" / "Souls" / "Sable",
    ...
    parser.add_argument('--llm-model', type=str, default='CrimsonDragonX7/SableValentine:latest',
                        help='LLM model name (default: CrimsonDragonX7/SableValentine:latest)')
